...
--
-- Hôte : localhost
-- Généré le : mar. 05 avr. 2022 à 15:42
...
ALTER TABLE `Annonces`
  ...
  ADD CONSTRAINT `Annonces_ibfk_2` FOREIGN KEY (`Num-id`) REFERENCES `Participation` (`Annonce`);

--
-- Contraintes pour la table `Utilisateurs`
--
ALTER TABLE `Utilisateurs`
  ADD CONSTRAINT `Utilisateurs_ibfk_1` FOREIGN KEY (`Num_Tel`) REFERENCES `Participation` (`Participant`);
COMMIT;
